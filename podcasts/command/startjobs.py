...
from podcasts.models import Reddit
...
def fetch_new():
    _feed = feedparser.parse("https://feeds.simplecast.com/54nAGcIl")
    save_new_episodes2(_feed)
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        logger.info("Added job: The Daily Feed.")
